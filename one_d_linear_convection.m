...
% Step 1 of 12 to Navier Stokes Code: One Dimmensional Linear Covection
%
% Governing Equation: 
% \frac{\partial{u}}{\partial{t}} + c\frac{\partial u}{\partial x} = 0
%
% This code is the first simplest CFD problem, which is essentially a wave
% propagation problem. This is an explicit time marching - upwind method 
% with a FD in time (n) and a BD in space (i)
%
% Discretization is: 
% \frac{u^{n+1}_{i} - u^{n}_{i}}{\Delta t} + C\frac{u^n_i - u^n_{i-1}}{\Delta x} = 0
%
